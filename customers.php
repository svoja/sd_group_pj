...
<html lang="en">
<?php
$pageTitle = 'Client Ledger | ARAII MOTO';
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div class="lg:col-span-1 anim-load" style="animation-delay: 0.1s;">
                <div class="bg-white border border-obsidian-edge p-8 relative overflow-hidden">
                    <div class="absolute top-0 right-0 p-2 font-mono text-sm text-premium/30 uppercase tracking-widest">Client_Access: Granted</div>
            ...
            <div class="lg:col-span-2 anim-load" style="animation-delay: 0.2s;">
                <div class="bg-white border border-obsidian-edge overflow-hidden h-full flex flex-col">
                    <div class="px-8 py-6 border-b border-obsidian-edge bg-white/[0.02] flex justify-between items-center">
                        ...
                        <span class="text-premium font-mono text-sm animate-pulse">[ NETWORK_SYNC_ACTIVE ]</span>
                    </div>
                        ...
                        <table class="w-full text-left border-collapse">
                            ...
                            <tbody class="divide-y divide-obsidian-edge">
                                ...
                                <tr class="group hover:bg-white/[0.01] transition-colors">
                                    ...
                                    <td class="px-6 py-5">
                                        <div class="text-sm font-mono text-obsidian-muted line-clamp-2 max-w-[200px]">
                                    ...
                                    <td class="px-6 py-5">
                                        ...
                                        <?php else: ?>
                                            <span class="inline-flex items-center gap-2 px-3 py-1 bg-white/5 border border-black/10 text-obsidian-muted text-sm font-black uppercase tracking-widest">
                                                STANDARD
                                            </span>
                                        <?php endif; ?>
                                    </td>
                                    ...
                                    <td class="px-6 py-5 text-right">
                                        <div class="flex justify-end gap-3 opacity-20 group-hover:opacity-100 transition-opacity duration-300">
                                            <a href="edit_customer.php?id=<?= $customer['customer_id'] ?>" class="text-sm font-black uppercase tracking-widest text-black/50 hover:text-black transition-colors">Edit</a>
                                ...
                                <?php endwhile; else: ?>
                                <tr>
                                    <td colspan="4" class="px-6 py-10 text-center text-obsidian-muted font-mono text-sm">No clients found in ledger.</td>
                                </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
