    ...
    <main class="flex-grow flex items-center justify-center p-8">
        <div class="w-full max-w-2xl bg-obsidian-surface border border-obsidian-edge p-8 relative shadow-2xl">
            ...
            <form action="actions/update_product.php" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="border border-obsidian-edge p-6 bg-obsidian-bg/50">
    
                    <label class="block text-[10px] uppercase tracking-[0.2em] text-obsidian-muted mb-4 font-bold">
                        Component Image
                    </label>
                    ...
                    <div class="flex items-center gap-6">
                        ...
                        <?php else: ?>
                            <div class="w-32 h-32 bg-obsidian-surface border border-obsidian-edge flex items-center justify-center text-[9px] font-mono text-obsidian-muted uppercase">
                                No_Image
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="flex-1">
                            <input type="file" 
                                name="product_image" 
                                accept="image/*"
                                class="w-full bg-obsidian-bg border border-obsidian-edge px-4 py-3 text-xs font-mono text-white file:bg-premium file:text-white file:border-0 file:px-4 file:py-2 file:mr-4 file:cursor-pointer">
                            
                            <p class="text-[9px] font-mono text-obsidian-muted mt-2 uppercase tracking-widest">
