            ...
            <div class="lg:col-span-1 anim-load" style="animation-delay: 0.1s;">
                <div class="bg-obsidian-surface border border-obsidian-edge p-8 relative overflow-hidden">
                    ...
                    <form action="actions/add_product.php" method="POST" enctype="multipart/form-data" class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                    <label class="block text-[10px] uppercase tracking-[0.2em] text-obsidian-muted mb-2 font-bold">Cost (USD)</label>
                            ...
                            <div>
                                <label class="block text-[10px] uppercase tracking-[0.2em] text-obsidian-muted mb-2 font-bold">Selling (USD)</label>
                        ...
                        <div>
                            ...
                            <input type="file" 
                                   ...
                                   accept="image/*"
                                   required
                                   class="w-full bg-obsidian-bg border border-obsidian-edge px-4 py-3 text-xs font-mono focus:outline-none focus:border-premium transition-colors text-white file:bg-premium file:text-white file:border-0 file:px-4 file:py-2 file:mr-4 file:cursor-pointer">
                        </div>
